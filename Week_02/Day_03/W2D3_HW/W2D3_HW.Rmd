...
row.names(two_week_forecast) <- c("Monday", "Tuesday", "Wednesday", 
                                  "Thursday", "Friday", "Saturday", "Sunday")
colnames(two_week_forecast) <- c("Week1", "Week2")
two_week_forecast
...
```{r}
two_week_forecast["Wednesday", "Week2"]
```
...
```{r}
two_week_forecast[c("Monday", "Wednesday", "Friday"), c("Week1", "Week2")]
```
